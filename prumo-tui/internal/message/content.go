...
// String renders the binary payload. It does not branch on provider: the
// client has no business knowing which provider is in use, and the harness is
// what speaks to the model.
