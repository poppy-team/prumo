...
func (m InitDialogCmp) View() tea.View { return tea.NewView(m.viewString()) }
func (m InitDialogCmp) viewString() string {
	...
	explanation := baseStyle.
		...
		Width(maxWidth).
		Padding(0, 1).
		Render("Initialization creates or updates AGENTS.md: the file agents read first, and the one you can freely edit to make them better at their job here.")
