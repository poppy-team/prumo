...
- Review workspace;
- Terminal workspace;
- Native Desktop / Workspace Viewer baseado em Oxi, conforme decisão vigente do Livro Vivo; a direção anterior Rust + Floem permanece somente como histórico/SUPERSEDED;
