...
> Status: Skill Package de referência para 79 — Programa de Aprimoramento do Workforce Agents.
...
[79.A — Baseline da Auditoria, Taxonomia de Lacunas e Matriz Mestra](baseline-da-auditoria-taxonomia-de-lacunas.md)

[79.B — Contratos Transversais, Schemas, Permissions, Evidence, Handoff e Lifecycle](contratos-transversais-schemas-permission.md)

[79.C — Hardening dos 26 Agents: Planejamento Individual](hardening-dos-26-agents-planejamento-indivi.md)

[79.D — Hardening das 14 Recipes: DAGs, Gates Condicionais, Recovery e Aceite](hardening-das-14-recipes-dags-gates-condic.md)

[79.E — Accessibility, UX e Cognitive Quality: Skills P0/P1](accessibility-ux-e-cognitive-quality-skill.md)

[79.F — Security, Trust, Permissions e Supply Chain: Skills P0/P1](security-trust-permissions-e-supply-chain.md)

[79.G — Context, Agentic Workflow, Orchestration, MCP e Indexing](context-agentic-workflow-orchestration-m.md)

[79.H — Testing, Code Quality, Review, Benchmarking e Evidence Strategy](testing-code-quality-review-benchmarking.md)

[79.I — Language Skills Contract e Hardening de Todas as lang-*](language-skills-contract-e-hardening-de-tod.md)

[79.J — Compiler, Native, Memory, Concurrency, Runtime e Low-Level Skills](compiler-native-memory-concurrency-runt.md)

[79.K — Backend, API, Database, Caching, Serialization e RPC Skills](backend-api-database-caching-serializat.md)

[79.L — Frontend, Design System, UI Implementation, Visual Quality e Web](frontend-design-system-ui-implementation.md)

[79.M — DevOps, CI/CD, Containers, Release Engineering e Observability](devops-ci-cd-containers-release-engineer.md)

[79.N — Git, GitHub, Documentation, Editor Tooling e Research Operations](git-github-documentation-editor-tooling.md)

[79.O — Game, Rendering, Physics, Networking, Assets, Audio e Realtime Skills](game-rendering-physics-networking-asset.md)

[79.P — Novas Capacidades Candidatas: Skills, Agents e Recipes](novas-capacidades-candidatas-skills-agents.md)

[79.Q — Matriz Completa de Prioridade, Work Packages, Dependências e Sequenciamento](matriz-completa-de-prioridade-work-package.md)

[79.R — Evals, Métricas, Canary, Definition of Done e Exit Gates do Workforce](evals-métricas-canary-definition-of-done.md)

[79.S — Architecture Quality, Goal Management, State e Plugin Architecture](architecture-quality-goal-management-stat.md)

[79.T — Technology Skill Packs: egui, Bubble Tea v2 e Ecossistemas de Frameworks](technology-skill-packs-egui-bubble-tea-v2.md)

[79.U — Skill Research, Knowledge Freshness, Vision e Evidence Operations](skill-research-knowledge-freshness-vision.md)

[79.V — Language Ecosystem Packs: C, C3, Odin, D, Lua e Nim](language-ecosystem-packs-c-c3-odin-d-lu.md)
...
[79.W — Modern C++, WASM/WAT, WebGPU, Three.js e Low-Level Systems Packs](modern-c++-wasm-wat-webgpu-three-js-e-lo.md)

[79.X — Programming Language Engineering, Paradigms, Compiler Theory e Language Design Skills](programming-language-engineering-paradigms.md)

[79.Y — Computer Science, Software Engineering, Databases e Advanced Linux Skills](computer-science-software-engineering-dat.md)

[79.Z — Teaching Module, Professor Agents e Neurodivergent Learning Architecture](teaching-module-professor-agents-e-neurodi.md)

[79.W — Modern C++, WebAssembly/WAT, WebGPU e Three.js Skill Packs](modern-c++-webassembly-wat-webgpu-e-three.md)

[79.X — Assembly, ISA, ABI, Reverse Engineering e Low-Level Systems Skills](assembly-isa-abi-reverse-engineering-e-l.md)

[79.Y — Programming Languages, Computer Science, Software Engineering, Databases e Linux Advanced Skills](programming-languages-computer-science-so.md)

[79.Z — Teaching Module: Professor Mode, Neurodivergent Pedagogy e Learning Progression](teaching-module-professor-mode-neurodiverg.md)
...
[79.AA — Grounding, Spec Compliance, Surface Conformance e Novas Skills do Prumo Unificado](grounding-spec-compliance.md)

# Amendment 2026-09-21 — Grounding e Prumo Unificado

[79.AA — Grounding, Spec Compliance, Surface Conformance e Novas Skills do Prumo Unificado](grounding-spec-compliance.md) integra formalmente grounding/spec compliance, implementation-reality verification, surface/protocol conformance, documentation promotion/reconciliation e agent-aware UI/UX ao Programa 79.

Também são metacontratos:

- [85 — Canonical Truth, Authority Graph e Constituição Anti-Invenção](../../contracts/llm-agent-execution-contract.md) — anti-invention/authority;
- [87 — Model Portfolio, Roteamento por Custo/Quota e Budget Mensal](../../runtime/model-portfolio-and-routing.md) — budget/routing;
- [88 — Arquitetura Documental v2: Canonical Graph, IR, Microcontextos e Promotion](../../architecture/documentation-architecture-v2.md) — microcontextos/documentation architecture;
